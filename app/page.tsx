          ...
          <div className="bg-gradient-to-br from-stone-900/95 to-amber-950/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-12 border border-amber-800/30">
            <div className="text-center mb-6">
              ...
              <p className="text-lg text-amber-300 leading-relaxed max-w-3xl mx-auto">
                La Maison Typology adalah Otoriter Hangat, dijalankan dengan sistem yang terstruktur dan terkontrol, dengan peran aktif admin sebagai pengarah suasana, penjaga etika, dan menjembatani diskusi. Meski bersifat otoriter, komunitas tetap membuka ruang untuk kehangatan, interaksi santai, serta saling berbagi pandangan dengan tetap menjaga batas dan relevansi.
              </p>
            </div>
          </div>
        </section>
